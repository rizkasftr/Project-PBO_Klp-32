...
public class LoginContainer extends JPanel {
    ...
    LoginContainer() {
      ...
      //   headerPanel.setBackground(Color.decode("#4467df"));
        headerPanel.setPreferredSize(new Dimension(300, 200));  // Memastikan header memiliki tinggi yang cukup

        JLabel headerImage = new JLabel();
        headerImage.setIcon(new ImageIcon("image/header3.jpg")); // Ganti dengan path gambar Anda
